...
361 IF I$=CHR$(165) THEN T$="ENERATING RINTFOX ILE":GOSUB 1120:GOSUB 30000:GOTO 399
...
30000 OPEN 1,DU,0,"TPLURKUNDE.FT"
30005 GET#1,A$,B$
30010 IF A$<>CHR$(84) THEN STOP
30020 CLOSE1
...
#30032 SLOW:GRAPHIC0:S=EA-DEC("1300"):PRINT "{CLR}SIZE:"S:GETKEYI$:FAST:GRAPHIC5
...
30070 CHAR 1,10,3,"TEMPLATE DONE. NOW SCORELIST"
...
30130 CHAR 1,10,3,"SCORELIST DONE. NOW PLAYERS."
