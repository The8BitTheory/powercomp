...
336 IF I$=CHR$(6) THEN IF INSTR(SM$,CHR$(CI))>0 THEN MN%=0:GOSUB 61000:GOTO410

# CONTROL +O FOR ORDER MENU
337 IF I$=CHR$(15) THEN IF INSTR(SM$,CHR$(CI))>0 THEN MN%=1:GOSUB 61000:GOTO410

# CONTROL +G FOR GENERATE MENU
338 IF I$=CHR$(7) THEN IF INSTR(SM$,CHR$(CI))>0 THEN MN%=2:GOSUB 61000:GOTO410
...
29810 PRINT "LOADING CHARSET...";:BLOAD "CHARSET.10",B0,P(BE):PRINT "DONE"
...
55000 IF ASC(I$)=95 THEN MN%=-1:MI%=0:GOSUB 1700:GOTO 55999
...
#       LOAD
55065   IF MI%=1 THEN GOSUB1700:MN%=-1:AC=0:CI=4:P=7:GOSUB 1100

#       SAVE
55070   IF MI%=2 THEN BEGIN
55072    GOSUB 1700:MN%=-1
55073    IF LEN(DN$)=0 THEN GOSUB 2100:ELSE GOSUB 1000
55074   BEND

#       SAVE AS
55075   IF MI%=3 THEN GOSUB 1700:MN%=-1:GOSUB 2100

#       EXIT
55080   IF MI%=5 THEN PRINT CHR$(142)"BYE!"CHR$(27)"L":END
