...
32 PM=31:DM=6:IM=0:DF=0:FD=0:TS=0:PI=0:CN$="":CD=0:SC=-1:DN$="":CF$="":T$="":PC=0:PW=0:AT=0:EA=0:TX=0:PO=0:PB=0:VP=0
...
364 IF ASC(I$)=182 THEN AC=0:GOSUB1600:GOSUB 1100:GOTO 400

# CBM+P - PREVIEW
365 IF I$=CHR$(175) THEN GOSUB 1900:GOTO 399

# CBM+N - NEW COMPETITION
366 IF I$=CHR$(170) THEN NW=-1:GOTO 400
