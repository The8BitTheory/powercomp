...
308   T$="OADING FROM ISK":GOSUB1120:GOSUB1150

310   CI=0:PI=0:P=PI+4:SC=-1


#     LOAD SCORE FILE. , 1160=SET RETURN PARAMS AND COMMENCE LOADING
312   IF AC=0 THEN GOSUB1160:AT=-1

#     LOAD TEMPLATE FILE
314   IF AC=1 THEN GOSUB30000:AT=-1
...
320  IF I$="" THEN BEGIN
321   IF LEN(CN$)=0 THEN CI=3:P=2:ELSE CI=0:P=PI+4
322   AT=-1
323  BEND

#    R TO RENAME FILE
325  IF I$="R" THEN BEGIN
326   GOSUB703:CI=6:SC=-1:GOSUB 705
327  BEND

#    D TO DELETE FILE
330  IF I$="D" THEN BEGIN
332   GOSUB 703:GOSUB2550:GOSUB705
334  BEND



339 BEND:IF AT THEN AT=0:SC=-1:GOTO 399
...
366 IF I$=CHR$(170) THEN NW=-1:GOTO 410
