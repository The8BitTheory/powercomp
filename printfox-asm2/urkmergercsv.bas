...
90 PRINT FRE(0) FRE(1):DIM DT$(50,3)

91 DOPEN #1,"WERTNG"+CI$+DI$+".CSV":IF DS<>0 THEN PRINT DS$" FILE "FI$:END
92 X=0:DO 
...
233  IF CS=62 THEN PRINT FI$" MISSING. SKIPPING.":MP$(MP)=DT$(R,3):MP=MP+1:GOTO299
