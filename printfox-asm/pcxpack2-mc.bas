...
# WRITE HEADER AND THEN COMPRESS DATA
10 GOTO 5070

# ONLY COMPRESS DATA, WITHOUT HEADER
15 GOTO 5310
...
5320 V=PEEK(A+I):V=255-V

5330  BANK B
5340  I=I+1
5350  N=PEEK(A+I):N=255-N
