...
27 AI$=CHR$(0)+CHR$(2)+CHR$(3)+CHR$(5)
#NI$:NUMERICAL INPUT (ALL EXCEPT FILE DIALOG)
28 NI$=CHR$(0)+CHR$(1)+CHR$(2)+CHR$(3)+CHR$(5)
...
292 IF CI=4 THEN BEGIN

#    SELECT FILENAME FROM FILE LIST
293  IF I$=CHR$(13) THEN T$="OADING FROM ISK":GOSUB1120:GOSUB1150:AT=-1

#    CLOSE FILELIST DIALOG WITHOUT LOADING FILE
294  IF I$="" THEN BEGIN
295   IF LEN(CN$)=0 THEN CI=3:P=1:ELSE CI=0:P=PI+4
296   AT=-1
297  BEND

317 BEND:IF AT THEN AT=0:SC=-1:PRINT"";:GOTO 399
...
# COMMODORE +1
322 IF I$=CHR$(129) THEN GOSUB703:CD=0:PI=0:P=PI+4:GOSUB1200:GOTO 399
# COMMODORE + 2-6
323 IF ASC(I$)>148 THEN IF ASC(I$)<155 THEN GOSUB703:CD=ASC(I$)-148:PI=0:P=PI+4:GOSUB1200:GOTO 399
...
# NUMERIC
340 IF ASC(I$)>47 THEN IF ASC(I$)<58 THEN IF INSTR(NI$,CHR$(CI))>0 THEN GOSUB 540:GOTO 410
# ALPHABETICAL LOWER CASE
342 IF ASC(I$)>64 THEN IF ASC(I$)<91 THEN IF INSTR(AI$,CHR$(CI))>0 THEN GOSUB 540:GOTO 410
# ALPHABETICAL UPPER CASE
344 IF ASC(I$)>192 THEN IF ASC(I$)<219 THEN IF INSTR(AI$,CHR$(CI))>0 THEN GOSUB 540:GOTO 410
