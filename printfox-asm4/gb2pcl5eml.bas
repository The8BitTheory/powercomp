...
252 PRINT"LOADING PCL5E.BIN...";:BLOAD"PCL5E.BIN",B0,U(DD)
#   WRITE START ADDRESS TO ZEROPAGE
255 POKE DEC("FB"),FNLB(A):POKE DEC("FC"),FNHB(A)

260 FAST

265 BL=NR*8-1

#   NR-LINES LB,HB AND RASTERLEN LB
270 SYS DEC("1300"),FNLB(BL),FNHB(BL),NC
#261 POKE56579,255
...
1085 PRINT"LOADING FOX2VDC.BIN...";:BLOAD"FOX2VDC.BIN",B0,U(DD):PRINT"DONE"
